...
function InstantResults({ results, onSelectCategory, onSelectTrader, onClose }) {
  ...
  if (!hasAny) {
    return (
      <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-[4px] shadow-xl border border-gray-100 z-50 px-4 py-5 text-center text-gray-400 text-sm">
        No results found
      </div>
    );
  }
  ...
  return (
    <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-[4px] shadow-xl border border-gray-100 z-50 max-h-[60vh] overflow-y-auto">
...
{showContactOptions && (
  ...
  >
    <div
      className="bg-white rounded-t-[8px] md:rounded-[8px] w-full md:max-w-sm p-6 pb-10 md:pb-6"
    ...
    >
      ...
      <div className="flex justify-around items-center">
        ...
        <a href="tel:+255748399067" className="flex flex-col items-center gap-2 group">
          <div className="w-16 h-16 rounded-[4px] bg-green-100 flex items-center justify-center group-hover:bg-green-200 transition shadow-sm">
        ...
        <a href="https://wa.me/255748399067" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 group">
          <div className="w-16 h-16 rounded-[4px] bg-emerald-100 flex items-center justify-center group-hover:bg-emerald-200 transition shadow-sm">
        ...
        <a href="sms:+255748399067" className="flex flex-col items-center gap-2 group">
          <div className="w-16 h-16 rounded-[4px] bg-blue-100 flex items-center justify-center group-hover:bg-blue-200 transition shadow-sm">
      ...
      <button
        onClick={() => setShowContactOptions(false)}
        className="mt-6 w-full py-2.5 rounded-[4px] bg-[#1a56db] text-white text-sm font-semibold hover:bg-[#1648c0] transition"
      >
        Cancel
      </button>
    </div>
